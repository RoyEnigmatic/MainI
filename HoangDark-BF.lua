...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://91650061358241",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=91650061358241";
v24.Parent = v23;
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://91650061358241") then
                    return v729;
                end
            end
        end
