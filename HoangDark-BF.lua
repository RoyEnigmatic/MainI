...
shared.LoaderTitle = "Administrator | Huỳnh Ngọc Hoàng";
...
local v7 = CreateObject("ImageLabel", {
    ...
    Image = "rbxassetid://128504363561748",
...
v23.Draggable = true;
v23.Image = "http://www.roblox.com/asset/?id=128504363561748";
v24.Parent = v23;
...
v16.Home:AddButton({
    ...
    Callback = function()
        setclipboard("https://discord.gg/t2ydx7P7");
    end
});
    ...
    function getHighestPoint()
        ...
        for v728, v729 in pairs(game:GetService("Workspace").Map.MysticIsland:GetDescendants()) do
            if v729:IsA("MeshPart") then
                if (v729.MeshId == "rbxassetid://128504363561748") then
                    return v729;
                end
            end
        end
