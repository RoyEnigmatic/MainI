...
Window = Fluent:CreateWindow({
    Title = "HTG Hub-Blox Fruit [ Free ] By ngochoangdzz",
    SubTitle = "",
    TabWidth = 155,
                    ...
                    if v.Name == "Cursed Skeleton Boss" and v:FindFirstChild("Humanoid") and v:FindFirstChild("HumanoidRootPart") and v.Humanoid.Health > 0 then
                        ...
                        elseif not hasNotified then
                            game.StarterGui:SetCore("SendNotification", {
                                ...
                                con = "rbxassetid://119024790478413",
                                Duration = 10,
                            })
                            hasNotified = true
                        end
...
game.StarterGui:SetCore("SendNotification", {
    ...
    Icon = "rbxassetid://119024790478413";
    Duration = 1e5;
	Button1 = "Yes";
	Button2 = "No";
})
...
ImageLabel.Image = "http://www.roblox.com/asset/?id= 119024790478413"
