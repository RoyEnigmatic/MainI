...
v0.new("<Color=Cyan>Welcome to Hoang Tiger Hub🐯<Color=/>"):Display();
wait(0.5);
...
v5.Window = function(v134, v135)
	...
	v197.Text = "Hoang Tiger Hub v0.2";
	v197.TextSize = 17;
...
v8.Image = "rbxassetid://128504363561748";
v8.Draggable = true;
...
game:GetService("StarterGui"):SetCore("SendNotification", {
	...
	Text = "Loading...",
	Icon = "rbxthumb://type=Asset&id=128504363561748&w=150&h=150",
	Duration = 10
});
spawn(function()
	while wait() do
